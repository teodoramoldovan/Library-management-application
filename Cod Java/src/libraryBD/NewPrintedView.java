...
public class NewPrintedView extends JPanel {
	...
	private static final long serialVersionUID = 1L;
	  ...
	  private JTextField publishingHouseTextField;
	  
	  private JButton cancelButton;
	  private JButton insertPrintedButton;

	  private GridBagConstraints constraints;

	  public NewPrintedView() {
		...
		publishingHouseLabel = new JLabel("Publishing house:");
		...
		publishingHouseTextField=new JTextField();

	    cancelButton = new JButton("Cancel");
	    insertPrintedButton = new JButton("Add Printed Book");
	    ...
	    constraints.gridy++;
	    constraints.gridx--;
	    add(publishingHouseLabel, constraints);

	    constraints.gridx++;
	    add(publishingHouseTextField, constraints);
	    ...
	    constraints.gridx++;
	    add(insertPrintedButton, constraints);
	  }
	  ...
	  public void addInsertPrintedButtonActionListener(ActionListener actionListener) {
	    insertPrintedButton.addActionListener(actionListener);
	  }
	...
	public JTextField getPublishingHouseTextField() {
		return publishingHouseTextField;
	}
