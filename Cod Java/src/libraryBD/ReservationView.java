	 ...
	 // private JTextField valabilityDateTextField;
	  ...
	  public ReservationView() {
	   ...
	   // valabilityDateTextField = new JTextField();
	    ...
	    createReservationButton = new JButton("Make reservation");
	    ...
	    constraints.gridx++;
	    add(createReservationButton, constraints);
	  }
	  ...
	  public void addCreateReservationButtonActionListener(ActionListener actionListener) {
	    createReservationButton.addActionListener(actionListener);
	  }
